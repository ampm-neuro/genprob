function [coefEsts, fit_yvals, obs_yvals] = plot_normal_logistic_fit_subj(trl_mtx, varargin)
...
% get wait times
[wait_times, frqs, frq_nums] = wait_times_prep(trl_mtx, 1, 3);
...
[fit_yvals, coefEsts, modelFun] = ampm_normal_logistic_fit(frq_nums, wait_times);

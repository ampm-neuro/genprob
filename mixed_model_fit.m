function [fixed_effects, random_effects, beta_pvals, coef_names, modelFun, unqfrq] = mixed_model_fit(probe_paths, varargin)
...
for isesh = session_ct_idx
    ...
    [trial_wait_times, trial_freqs] = wait_times_prep(trl_mtx, 1); %1 for means, 2 for all
...
%starting_vals = [1 1 1 1];
starting_vals = [11 10 15 8];

[fixed_effects,~,stats,random_effects] = nlmefit(tone_input,wait_input,subject_input,[],modelFun,starting_vals);

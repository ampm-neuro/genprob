...
% deal with single cell input
if iscell(varargin{1})
   varargin_hold = cell(1,size(varargin{1},2));
   for i = 1:length(varargin{1})
       varargin_hold{i} = varargin{1}{i};
   end
   if length(varargin)==1
       varargin = varargin_hold;
   else
       varargin = [varargin_hold varargin(2:end)];
   end
end

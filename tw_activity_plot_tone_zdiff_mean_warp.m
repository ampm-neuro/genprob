function zdiffs = tw_activity_plot_tone_zdiff_mean_warp(trl_mtx, trl_idx, frame_times, traces, neurons, trials, align_event, tw_bounds, event_time_spacing, varargin)
...
ylim([0+0.5 size(zdiffs,1)+0.5])
xlim([0.5 size(zdiffs,2)+0.5])
xticks(xticks_hold)

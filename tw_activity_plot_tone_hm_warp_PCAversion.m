function [all_matrices, utones, tw_bounds] = tw_activity_plot_tone_hm_warp_PCAversion(trl_mtx, trl_idx, frame_times, traces, neurons, trials, align_event, tw_bounds, tses)

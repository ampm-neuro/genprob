function hm_cells = tw_activity_trial_hm_full_warp(trl_mtx, trl_idx, frame_times, traces, neurons, trials, tw, tses)
...
for ineuron = 1:length(neurons)
    hm_cells{ineuron} = tw_activity_trial_hm_warp(trl_mtx, trl_idx, frame_times, traces, neurons(ineuron), trials, tw);
end
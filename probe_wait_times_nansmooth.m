function [mean_waits, subj_ids, all_waits] = probe_wait_times_nansmooth(folder_in, probes_in, tones_in, varargin)
...
for iprobe = probes_in
    ...
    if iprobe <= 6
        ...
        [~, ~, all_wait_times] = noplot_allprobes(ppaths);
    ...
    % smooth
    %all_wait_times = nansmooth_adaptive_ampm(all_wait_times, 5, 5);
